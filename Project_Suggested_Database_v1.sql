...
CREATE TABLE Comments (
    ...
    FOREIGN KEY (PostID) REFERENCES Listing(PostID),
    FOREIGN KEY (UserID) REFERENCES `Users`.`Users`(UserID)
);
...
-- Insert into Parts
INSERT INTO Parts (Name, AuthenticationNum, Category, Description, Price, QuantityAvailable, Location, Brand, Model, status) VALUES 
('Part A', '12345', 'Electronics', 'Description of part A', 99.99, 10, 'Korea', 'BMW', 'X5', 'Available'),
('Part B', '67890', 'Automotive', 'Description of part B', 199.99, 5, 'USA', 'Mini Cooper', 'Countryman', 'Available'),
('Part C', '11223', 'Hardware', 'Description of part C', 9.99, 20, 'Europe', 'Ferrari', '812 GTS', 'Available');
...
INSERT INTO UserAuth (UserID, Email, PasswordHash, LastLogin, FailedLoginAttempts, PasswordResetToken, TokenExpiryDate) VALUES 
(1, 'john.doe@example.com', 'hashedpassword1', NOW(), 0, NULL, NULL),
(2, 'jane.smith@example.com', 'hashedpassword2', NOW(), 1, 'token123', NOW() + INTERVAL 1 DAY),
(3, 'bob.brown@example.com', 'hashedpassword3', NOW(), 2, 'token456', NOW() + INTERVAL 2 DAY);
...
-- Assuming PartIDs from Parts table: 1, 2, 3 and UserIDs from Users table: 1, 2, 3
-- Insert into Listing
INSERT INTO Listing (PartID, UserID, Content, PostDate) VALUES 
(1, 1, 'Selling Part A, barely used', NOW()),
(2, 2, 'Looking for Part B, willing to trade', NOW()),
(3, 3, 'Discount on Part C for bulk purchase', NOW());

-- Assuming PostIDs from Listing table: 1, 2, 3
-- Insert into Comments
INSERT INTO Comments (PostID, UserID, Content, CommentDate) VALUES 
